...
rollup을 만들었고 최근엔 svelte를 만든 [Rich harris가 Vercel에 합류](https://vercel.com/blog/vercel-welcomes-rich-harris-creator-of-svelte)했어요. 이 소식 뒤에 바로 Vercel의 투자 유치 소식이 들려왔는데, 커뮤니티에서는 Rich harris영향력이 이정도라고? 하는 이야기도 떠돌았어요.
